...
userRouter.post("/signin", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const message = new TextEncoder().encode("Jaldi se Jaldi Permission dedo sirf jaldi se jaldi permission dedo sir");
...
userRouter.get("/presigned-url", middleware_1.authMiddleWare, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    //@ts-ignore
